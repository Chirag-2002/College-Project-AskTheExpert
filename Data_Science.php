...
<body class="d-flex">
  ...
  <div class="container">
    ...
    <h1 class="text-center fs-3 m-5 text-success">LIST OF EXPERT TUTOR IN DATA SCIENCE </h1>
    <table class="table">
      ...
      $selectquery="SELECT  `Name`, `Skills`, `Mobile_Number` FROM `tutor` WHERE Skills='AI' or Skills='DATA SCIENCE'";
